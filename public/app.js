$(document).ready(function() {
  ...
  //peticion ajax para conseguir todos los datos filtrados
  $('#buscar').click(function() {
      if ($("#checkPersonalizada")[0].checked){//si la pestaña de personalizada esta activa busca la propiedad filtrada
          ...
          var urls = "http://localhost:3000/search"; //si la pestaña de personalizada no esta activa muestra todos los datos sin filtrar
      }
      $.ajax({
          url: urls,
          type: 'get',
  ...
  // borra las opciones de la etiqueta <option>
